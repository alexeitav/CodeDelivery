...
Route::group(['prefix'=>'admin','middleware'=>'auth.checkrole:admin', 'as'=>'admin.'], function(){
    ...
    Route::group(['prefix'=>'orders', 'as'=>'orders.'], function(){
        ...
        Route::get('', ['as'=>'index', 'uses'=>'OrdersControllers@index']);
        Route::get('edit/{id}', ['as'=>'edit', 'uses'=>'OrdersControllers@edit']);
        Route::post('update/{id}', ['as'=>'update', 'uses'=>'OrdersControllers@update']);
